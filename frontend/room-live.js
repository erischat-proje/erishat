(() => {
  ...
  function ensureRoomSurface(){
    ...
    style.textContent=\`
      ...
      .eris-room-top button{border:1px solid #ffffff18;background:rgba(8,7,11,.38);color:#fff;border-radius:14px;width:42px;height:42px;box-shadow:0 8px 22px #0004}.eris-room-top button:active{transform:scale(.96)}
