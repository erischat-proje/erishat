...
class Ledger(Base):
    ...
    target_user_id = Column(String(64), ForeignKey("users.id"), nullable=True)  # Hediye vb. transferler için
    module = Column(String(32), index=True, nullable=False)  # "gift", "vip", "room", "family", "music", "game"
    action = Column(String(64), nullable=False)  # "debit", "credit", "transfer"
